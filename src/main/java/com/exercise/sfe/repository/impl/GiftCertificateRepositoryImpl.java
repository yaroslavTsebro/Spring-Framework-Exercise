...
import com.exercise.sfe.utility.impl.GiftCertificateSearchQueryBuilder;
...
public class GiftCertificateRepositoryImpl extends BaseRepository implements
  ...
  public Optional<GiftCertificate> getById(Long id) {
    return jdbcTemplate.queryForStream(
        GiftCertificateSQLQueries.GET_GIFT_CERTIFICATE_BY_ID, rowMapper, id).findFirst();
  }
  ...
  public GiftCertificate create(GiftCertificate giftCertificate) {
    ...
    var createDate = (Timestamp) generated.get("create_date");
    giftCertificate.setId(id);
    giftCertificate.setCreateDate(createDate.toLocalDateTime());
    giftCertificate.setLastUpdateDate(createDate.toLocalDateTime());
  ...
  @Override
  public List<GiftCertificate> findAll(SearchingSettings settings) {
